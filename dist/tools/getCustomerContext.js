...
export const definition = {
    ...
    description: "Recupera il contesto operativo del cliente: versione software installata, moduli abilitati, personalizzazioni attive e data dell'ultimo deployment.",
    inputSchema: {
        type: "object",
        properties: {
            customerId: {
