...
export const definition: McpToolDefinition = {
  ...
  description:
    "Recupera estratti di log applicativi recenti del cliente, opzionalmente filtrati per modulo. Utile per individuare errori, eccezioni e stack trace correlati al ticket.",
  inputSchema: {
    type: "object",
    properties: {
      customerId: {
      ...
      module: {
        type: "string",
        description:
          "Modulo da usare come filtro sulle righe di log (es. Billing, Orders)",
      },
      maxLines: {
        type: "number",
        description:
          "Numero massimo di righe di log da restituire (default: 50)",
      },
    },
    required: ["customerId"],
  },
